// Generated by TKG at 2017-01-02 09:20:30
...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [0] = KEYMAP_TKG(
        ...
        LSFT,     Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,FN0, UP,   \
        LCTL,LALT,LGUI,          SPC,                     GRV, LEFT,DOWN,RGHT),
    [1] = KEYMAP_TKG(
        GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, DEL,  \
        TRNS,BTN1,MS_U,BTN2,TRNS,TRNS,TRNS,MPRV,MPLY,MNXT,MUTE,VOLD,VOLU,BSLS, \
        TRNS,MS_L,MS_D,MS_R,TRNS,TRNS,LEFT,DOWN,UP,  RGHT,TRNS,TRNS,     ENT,  \
        TRNS,     PGUP,PGDN,HOME,END, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, \
